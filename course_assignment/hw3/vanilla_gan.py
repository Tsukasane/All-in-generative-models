...
def training_loop(train_dataloader, opts):
    ...
    for _ in range(opts.num_epochs):
        ...
        for batch in train_dataloader: # real_images are not on the computational graph while fake_images are.
            ...
            # 2. Sample noise
            noise = sample_noise(opts.batch_size, opts.noise_size) # TODO 100 is indicated by the figure
